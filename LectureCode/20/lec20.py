...
start = "1/1/2021 3:30PM"
end = "1/1/2021 4:00PM"
w_one = Workout(start, end)
...
start = '1/1/2021 3:35PM'
end = '1/1/2021 4:00PM'
w_two = Workout(start, end)
print(w_two.start)
w_two.__dict__['my_attribute'] = 1
print(w_two.my_attribute)
print(w_two.__dict__['start'])
...
def total_elapsed_time(L):
    ...
    #     sum += diff
    # return sum
    diff_l = [(parser.parse(e2) - parser.parse(e1)).total_seconds() for e1, e2 in L]
    print(diff_l)
    return sum(diff_l)
